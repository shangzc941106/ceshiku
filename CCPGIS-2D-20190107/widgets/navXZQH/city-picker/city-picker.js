    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:0px;' +
        ...
        getWidthStyle: function (w, dropdown) {
            if (this.options.responsive && !$.isNumeric(w)) {
                ...
                return 'width:' + (dropdown ? Math.max(200, w) : w) + 'px;';
            }
        },
        ...
        simplize: function (address, type) {
            ...
            if (type === PROVINCE) {
                ...
                return address.length > 2 ? address.replace(/[市,区,县,自治县,旗]/g, '') : address;
            }
        },
